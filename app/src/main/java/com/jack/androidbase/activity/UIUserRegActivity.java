...
public class UIUserRegActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button mSureButton,mCancelButton;                       //确定按钮,取消按钮
    private UserDataManager mUserDataManager;         //用户数据管理类

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ui_user_reg);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.register_btn_cancel:                     //取消按钮的监听事件,由注册界面返回登录界面
                Intent intent_Register_to_Login = new Intent(UIUserRegActivity.this, UIUserLoginActivity.class);    //切换User Activity至Login Activity
